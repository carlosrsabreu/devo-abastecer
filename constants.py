...
# Fuel name patterns. PDF text extraction drops accents and scatters words or
# individual letters, so each pattern tolerates that.
GASOLINE_95_PATTERN = (
...
# CSV
CSV_HEADER = "start_date,end_date,gasolina_IO95,gasoleo_rodoviario,gasoleo_colorido_marcado,gasolina_IO98,pdf_url\n"
